...
import { AiOutlineUser, AiOutlineEye, AiFillEdit, AiFillDelete } from 'react-icons/ai';
  ...
  return (
    <div>
      <div className="mx-auto mt-8 p-4 min-h-[400px] bg-white shadow rounded-lg flex flex-col">
        ...
        <div className="text-gray-600 flex-grow whitespace-pre-line">{post.objData.content}</div>
        {isAuthor && (
