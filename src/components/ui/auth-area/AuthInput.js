...
export default function AuthInput({
  ...
  return (
    <div className='relative mt-8'>
      <p className='pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600 sm:absolute sm:bg-white'>
        {type.title}
      </p>
      <div
        className='flex items-center justify-between border placeholder-gray-400 focus:outline-none
                  w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base bg-white
